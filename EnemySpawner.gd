...
func _on_Timer_timeout():
	...
	var spawn_side = [Vector2(rng.randi_range(0, 320), centre.y - height), 
					Vector2(centre.x - width, rng.randi_range(0, 180)), 
					Vector2(rng.randi_range(0, 320), centre.y + height), 
					Vector2(centre.x + width, rng.randi_range(0, 181))]
